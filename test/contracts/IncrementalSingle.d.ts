...
interface IncrementalSingleInterface extends ethers.utils.Interface {
  functions: {
...
export class IncrementalSingle extends Contract {
  ...
  interface: IncrementalSingleInterface;
